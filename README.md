...
This is a deploy-tracking stamp, not a strict semver contract; git remains the source of truth for what changed. What changed in each release, including breaking changes to variable names, lives on the [releases page](https://github.com/anderix/axe/releases).
